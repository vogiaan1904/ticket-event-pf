...
func (x *GetManyOrdersRequest) GetCursor() string {
	if x != nil {
		return x.Cursor
	}
	return ""
...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x05order\x1a\x1bgoogle/protobuf/empty.proto\"\xb5\x03\n" +
	"\x05Order\x12\x12\n" +
	...
	"\bhas_next\x18\x04 \x01(\bR\ahasNext\"\x87\x01\n" +
	"\x14GetManyOrdersRequest\x12\x16\n" +
