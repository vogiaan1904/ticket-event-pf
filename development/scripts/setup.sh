...
docker-compose up -d redis-waitroom redis-auth postgres-inventory postgres-event postgres-payment postgres-user mongo-order zookeeper kafka postgres-temporal elasticsearch-temporal temporal
